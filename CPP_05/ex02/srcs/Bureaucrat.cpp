...
/*   Updated: 2024/01/18 13:34:46 by tajavon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const & form)
{
	try
	{
		...
		display_point_color(BHGREEN);
		std::cout << BHMAG << this->_name << RESET
		<< BHWHITE << " executed " << RESET << BHCYAN << form.getName() << RESET << std::endl;
	}
	catch(const std::exception& e)
	{
		display_point_color(BHRED);
		std::cout << BHMAG << this->_name << RESET
		<< BHWHITE << " couldn't executed " << RESET << BHCYAN << form.getName() << RESET
		<< BHWHITE << " because " << BHRED << e.what() << RESET << "." << std::endl;
	}
