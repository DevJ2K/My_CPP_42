...
/*   Updated: 2024/01/05 10:59:24 by tajavon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	display_big_line("CHECK TYPE");
	AAnimal* chien = new Dog();
	std::cout << chien->getType() << std::endl;

	AAnimal* chat = new Cat();
	std::cout << chat->getType() << std::endl;

	delete chien;
	delete chat;

	// display_big_line("INSTANCE AAnimal");
